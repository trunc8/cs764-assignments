...
frontImg = cv2.imread("../data/augment_book/"+'front.png')
sideImg = cv2.imread("../data/augment_book/"+'side.png')
...
for p in range(len(img_points)):
    ...
    # im = draw_texture_on_img(img[p], projects,frontImg)
